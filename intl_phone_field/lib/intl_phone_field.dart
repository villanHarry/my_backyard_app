          ...
          Expanded(
            child: TextFormField(
              ...
              decoration: widget.decoration.copyWith(
                ...
                fillColor:  widget.gradient==true? const Color(0xff540163).withOpacity(0.4):null,
              ),
              style: widget.style,
              onSaved: (value) {
                widget.onSaved?.call(
              ...
              inputFormatters: [
                LengthLimitingTextInputFormatter( widget.disableLengthCheck ? null : _selectedCountry.maxLength),
              ],
  ...
  Container _buildFlagsButton() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color:  widget.gradient==true? const Color(0xff540163).withOpacity(0.4):null,
      ),
      ...
      child: DecoratedBox(
        ...
        child: InkWell(
          ...
          onTap:  widget.countryReadOnly ? null:_changeCountry,
          child: Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                if (widget.showCountryFlag) ...[
                  !kIsWeb
                      ? ClipRRect(
                    // backgroundImage: AssetImage( 'assets/flags/${_selectedCountry.code.toLowerCase()}.png',),
